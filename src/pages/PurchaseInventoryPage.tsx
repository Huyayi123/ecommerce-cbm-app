    ...
    <>
      ...
      <section className="panel">
        ...
        <div className="filter-grid inventory-filter-grid">
          ...
          <label>装货方式<select value={filters.loadingType} onChange={(event) => setFilters({ ...filters, loadingType: event.target.value as PurchaseRecord['loadingType'] | 'all' })}><option value="all">全部</option><option value="整柜">整柜</option><option value="冠通">冠通</option><option value="海川">海川</option></select></label>
        ...
        {canEditData && <div className="record-form">
          ...
          <label>装货方式<select value={draft.loadingType || '整柜'} onChange={(event) => patchDraft('loadingType', event.target.value as PurchaseRecord['loadingType'])}><option value="整柜">整柜</option><option value="冠通">冠通</option><option value="海川">海川</option></select></label>
